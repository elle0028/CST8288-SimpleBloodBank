...
INSERT INTO `simplebloodbank`.`blood_bank` (`bank_id`, `owner`, `name`, `privately_owned`, `established`, `employee_count`) VALUES ('1', '1', 'BloddyBank', b'1', '6666-07-13 13:07:13', '166616661');
INSERT INTO `simplebloodbank`.`blood_bank` (`bank_id`, `owner`, `name`, `privately_owned`, `established`, `employee_count`) VALUES ('2', null, 'Bank', b'0', '2020-01-01 12:00:00', '100');
