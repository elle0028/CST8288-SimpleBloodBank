     ...
     */
     protected void processRequest( HttpServletRequest request, HttpServletResponse response )
        ...
        try( PrintWriter out = response.getWriter() ) {
            ...
            DonationRecordLogic drlogic = new DonationRecordLogic();
          //  Logic<DonationRecord> drlogic = LogicFactory.getFor( "DonationRecord" );
            out.println( "<tr>" );
            ...
            drlogic.getColumnNames().forEach( e -> out.printf( "<th>%s</th>", e ) );
//            out.println( "<th>ID</th>" );
//            out.println( "<th>Perons_id</th>" );
//            out.println( "<th>Donation_id</th>" );
//             out.println( "<th>administrator</th>" );
...
//            }
            drlogic.getAll().forEach( e -> out.printf( "<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><tr>",
                    drlogic.extractDataAsList( e ).toArray() ) );

            out.println( "<tr>" );
            //this is an example, for your other tables use getColumnNames from
            //logic to create headers in a loop.
            drlogic.getColumnNames().forEach( c -> out.printf( "<th>%s</th>", c ) );
//            out.println( "<th>ID</th>" );
...
//            out.println( "<th>Password</th>" );
    ...
    protected void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        DonationRecord donation_record = logic.updateEntity( request.getParameterMap() );
