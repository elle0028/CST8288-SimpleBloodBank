...
@NamedQueries( {
    ...
    @NamedQuery( name = "BloodDonation.findContaining",     query = "SELECT b FROM BloodDonation b WHERE b.rhd like CONCAT('%', :search, '%') or b.bloodGroup like CONCAT('%', :search, '%') or b.milliliters like CONCAT('%', :search, '%')" )
} )
