...
@NamedQueries( {
    ...
    @NamedQuery( name = "BloodDonation.findContaining",     query = "SELECT b FROM BloodDonation b WHERE b.bloodBank.bankId like CONCAT('%', :search, '%') or b.bloodGroup like CONCAT('%', :search, '%') or b.created like CONCAT('%', :search, '%')" )
} )
